<x-layout>
    ...
    <form action="{{ url('/companies/' . $company->id . '/update') }}" method="POST">
        ...
        <div>
            ...
            <input type="text" name="contact_email" id="contact_email" value="{{ old('contact_email', $company->contact?->email) }}">
            @error('contact_email')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="owner_email" id="owner_email" value="{{ old('owner_email', $company->owner?->email) }}">
            @error('owner_email')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
