...
class ProductController extends Controller
{
    ...
    public function getProductsPublic(Request $req)
    {
        ...
        return view('public.products', compact('products', 'categories', 'companies'));
    }


    public function getProductsJson(Request $request)
    {
        $query = $request->input('query'); // holds query value from URL
        $productsQuery = Product::where('hidden', 0); // Store all products that is not hidden.
