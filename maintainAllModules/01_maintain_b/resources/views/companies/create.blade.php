<x-layout>
    ...
    <form action="{{ url('/companies') }}" method="POST">
        ...
        <div>
            ...
            <input type="owner_name" name="owner_name" id="owner_name" value="{{ old('owner_name') }}">
            @error('owner_name')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="contact_name" name="contact_name" id="contact_name" value="{{ old('contact_name') }}">
            @error('contact_name')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
