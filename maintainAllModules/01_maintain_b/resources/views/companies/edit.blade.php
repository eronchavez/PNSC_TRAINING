<x-layout>
    ...
    <form action="{{ url('/companies/' . $company->id . '/update') }}" method="POST">
        ...
        <div>
            ...
            <textarea name="address" id="address" cols="30" rows="10">{{old('address', $company->address)}}</textarea>
            @error('address')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="owner_name" name="owner_name" id="owner_name" value="{{ old('owner_name', $company->owner->name) }}">
            @error('owner_name')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="contact_name" name="contact_name" id="contact_name" value="{{ old('contact_name', $company->contact->name) }}">
            @error('contact_name')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
