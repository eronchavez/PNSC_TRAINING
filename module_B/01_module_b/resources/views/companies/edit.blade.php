<x-layout>
    ...
    <form action="{{ url('/companies/' . $company->id . '/update') }}" method="POST">
        ...
        <div>
            ...
            <input type="tel" name="telephone" id="telephone" value="{{ old('telephone', $company->telephone) }}">
            @error('telephone')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="tel" name="owner_mobile" id="owner_mobile" value="{{ old('owner_mobile', $company->owner?->mobile) }}">
            @error('owner_mobile')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="tel" name="contact_mobile" id="contact_mobile" value="{{ old('contact_mobile', $company->contact?->mobile) }}">
