...
class ProductController extends Controller
{
    ...
    public function changeImage(Product $product, Request $req)
    {   
        $req->validate([
            'image' => 'required'
        ]);
        ...
        return redirect()->back()->with('success', 'Product Image successfuly changed!');
    }
    ...
    {
        $product->delete();
        return redirect('/products')->with('success', 'Proudct Successfully deleted!');
    }
}
