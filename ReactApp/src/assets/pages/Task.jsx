          ...
          {tasks.length > 0 ? (
            tasks.map((task) => (
              <div key={task?.id} className="task-card">
                <input type="checkbox" className="circle-check" key={task.id} id={`circle-check-${task.id}`}/>
                ...
                <div className="task-card-content">
                  ...
                  <div className="sub-task">
                    ...
                    <p className={formatDueDate(task.due_date).isOverDue ? "due-red" : ""}>{formatDueDate(task.due_date).text}</p>
