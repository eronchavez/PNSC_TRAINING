<x-layout>
    ...
    <form action="{{ url('/products') }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            <label for="catetgory_id">category</label>
          ...
          <div>
            ...
            <input type="number" name="gross_weight" id="gross_weight" value="{{ old('gross_weight') }}" step="any"> 
            @error('gross_weight')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
          ...
          <div>
            ...
            <input type="number" name="net_weight" id="net_weight" value="{{ old('net_weight') }}" step="any"> 
            @error('net_weight')
                <p style="color: red">{{$message}}</p>
            @enderror
        </div>
