...
export default function Carparks({ setFocused, focused }) {
  ...
  const sortedCarparks = [...carparkWithDistance].sort(
    (a, b) =>
    ...
    return (
      <li>
        ...
        {focused.distance != null && (
          <p>Location {focused.distance.toFixed(1)} km away</p>
        )}
      </li>
    );
  }
