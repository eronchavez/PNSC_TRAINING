...
INSERT INTO `categories` VALUES (1,'eco_friendly'),(2,'family'),(3,'hand_made'),(4,'luxury');
...
CREATE TABLE `companies` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_companies_contacts_idx` (`contact_id`),
  KEY `fk_companies_owners1_idx` (`owner_id`),
  CONSTRAINT `fk_companies_contacts` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`),
  CONSTRAINT `fk_companies_owners1` FOREIGN KEY (`owner_id`) REFERENCES `owners` (`id`)
...
-- Dump completed on 2026-07-17 13:17:19
